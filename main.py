import os
from models.pasta_model import Pasta
from controllers.pasta_controllers import PastaController
from views.pasta_view import PastaView
...
if __name__ == "__main__":
    ...
    my_controller = PastaController(my_model)
    my_view = PastaView(my_controller)
